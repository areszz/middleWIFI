...
public class SQLiteDbManager<TAG> {
    ...
    //数据库存储路径
    String filePath = "data" + Environment.getDataDirectory().getAbsolutePath() +"/com.example.signinproject/databases/WIFILocaterDB.db";

    // 数据库存放的文件夹 data/data/com.zwinsoft.voice 下面
    String pathStr = "data" + Environment.getDataDirectory().getAbsolutePath() +"/com.example.signinproject/databases";
